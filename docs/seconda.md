...
// FILTRO: Cerca articoli con 'class_target' uguale a '2' o 'Tutti'
// Assicurati che nel frontmatter degli articoli ci sia: class_target: 2
...
<div v-else class="content animated-fade">
  ...
  <div v-if="classPosts.length === 0"><p>Non ci sono ancora materiali specifici per questa classe.</p></div>
...
.post-thumb {
  width: 150px; min-height: 100px; background-size: cover;
