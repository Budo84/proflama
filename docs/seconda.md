...
// Assicurati che il percorso sia corretto rispetto alla tua struttura  
...
sessionStorage.setItem('sblocco\_2', 'ok')  
} else {  
errore.value \= true  
}  
}  
...
onMounted(() \=\> {  
if (sessionStorage.getItem('sblocco\_2') \=== 'ok') {  
sbloccato.value \= true  
}  
})  
// FILTRO CLASSE: Mostra solo gli articoli per "2" (es. 2A, 2B) oppure per "Tutti"  
// La funzione startsWith('2') cattura tutto ciò che inizia con 2 (2A, 2B, 2C...)  
const classPosts \= posts.filter(post \=\>  
post.class\_target \=== 'Tutti' || post.class\_target.startsWith('2')  
)  
\</script\>  
...
\<div class="lock-box"\>  
\<h3\>Area Protetta\</h3\>  
\<p\>Questa pagina è riservata alle classi Seconde.\</p\>  
...
\<p class="welcome-msg"\>✅ Accesso effettuato. Ecco i materiali per le Seconde:\</p\>  
...
\<a :href="post.url" class="post-link"\>  
    ...
    \<div class="post-content"\>  
      \<h3\>{{ post.title }}\</h3\>  
      \<p class="post-meta"\>  
         \<\!-- Mostra un badge se l'articolo è specifico per la classe \--\>  
         \<span v-if="post.class\_target \!== 'Tutti'" class="badge-class"\>{{ post.class\_target }}\</span\>  
